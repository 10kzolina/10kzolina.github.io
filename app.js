(function () {
  ...
  const SPONSOR_LOGOS = [
    { name: "Masxmenos", logo: "img_resized/masxmenos.PNG" },
    { name: "Caja Rural de Navarra", logo: "img_resized/cajarural.PNG" },
    { name: "E.Leclerc", logo: "img_resized/leclerc.PNG" },
    { name: "Sporty", logo: "img_resized/sporty.png" },
    { name: "100K Mendi Taldea", logo: "img_resized/100k.jpeg" },
    { name: "Rocopolis", logo: "img_resized/rocopolis.png" },
    { name: "Bordaberri", logo: "img_resized/bordaberri.JPG" },
    { name: "Solonuts", logo: "img_resized/solonuts.jpg" },
    { name: "Ipar Kirolak", logo: "img_resized/iparkirolak.png" },
    { name: "Origen Real Food", logo: "img_resized/origen.png" },
    { name: "Saltoka Jump", logo: "img_resized/saltoka.png" },
    { name: "Repostería Juan Miguel", logo: "img_resized/reposteriajuanmiguel.png" },
    { name: "Farmacia Arteche", logo: "img_resized/farmaciaAtreche.png" },
    { name: "Carnicería Deierri", logo: "img_resized/carniceriadeierri.png" },
    { name: "Beep Run Club", logo: "img_resized/beeprun.jpg" },
    { name: "Aske Clothes", logo: "img_resized/askeclothes.jpg" },
    { name: "Lekuona", logo: "img_resized/lekuona.jpg" },
    { name: "Irish Pub Eskiroz", logo: "img_resized/irishpub.PNG" },
    { name: "Hiruda 3D", logo: "img_resized/hiruda3d.jpg" },
    { name: "Aaron Vilchez DJ", logo: "img_resized/aaron.jpg" },
    { name: "Sidrería Auzmendi", logo: "img_resized/auzmendi.png" },
    { name: "N2 Fisioterapia", logo: "img_resized/n2fisio.png" },
    { name: "Kaiku", logo: "img_resized/kaiku.png" },
    { name: "La Perla", logo: "img_resized/laperla.png" },
    { name: "Reyno Gourmet", logo: "img_resized/reyno.png" },
    { name: "Malie Estética Avanzada", logo: "img_resized/malie.PNG" },
    { name: "Heladería Los Jijonencos", logo: "img_resized/losjijonecos.PNG" },
    { name: "Txaranga Turrutxiki", logo: "img_resized/txaranga.PNG" }
  ];
